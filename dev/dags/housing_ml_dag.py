...
def housing_ml_dag():
    ...
    @snowpark_ext_python_task(python=_SNOWPARK_BIN,
        ...
        task_id="register_sproc_to_create_model"
    )
    def register_sproc_to_create_model_func():
    ...
    @snowpark_ext_python_task(python=_SNOWPARK_BIN, conn_id="snowflake_default", task_id="define_predict_udf")
    ...
    @snowpark_ext_python_task(python=_SNOWPARK_BIN, conn_id="snowflake_default", task_id="do_prediction")
