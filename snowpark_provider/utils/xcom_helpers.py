...
def get_snowflake_xcom_objects() -> dict:
    ...
    ), "AIRFLOW__CORE__XCOM_SNOWFLAKE_TABLE is not a fully-qualified Snowflake table objet"
    ...
    ), "AIRFLOW__CORE__XCOM_SNOWFLAKE_STAGE is not a fully-qualified Snowflake stage objet"
