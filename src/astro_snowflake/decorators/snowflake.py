...
class _SnowServicesPythonDecoratedOperator(DecoratedOperator, SnowServicesPythonOperator):
    """
...
def snowservices_python(
    ...
    **kwargs,
    ...
    """Wraps a python callable into an Airflow operator to run via a Snowservices runner.
    ...
    return task_decorator_factory(
        ...
        decorated_operator_class=_SnowServicesPythonDecoratedOperator,
        **kwargs,
    )